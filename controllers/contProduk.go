...
func GetProduk(c echo.Context) error {
	...
	// 	q = q.Joins("join tbl_produk t3 <on></on> t3.id_produk = t1.id_produk")
	// 	q = q.Joins("join tbl_produk_files t5 on t5.id_produk = t1.id_produk")
	...
	// 	// get All photo
	// 	var photos []models.Tbl_produk_files
	// 	q3 := con
	// 	q3 = q3.Table("tbl_usaha_produk t1")
	// 	q3 = q3.Joins("join tbl_produk_files t2 on t2.id_produk = t1.id_produk")
	...
	// } else if flag == 1 {
	// 	q = q.Select(
	// 		"t1.id,tbl_kube.nama_kube as nama,tbl_user.alamat,tbl_user.no_hp,tbl_produk.nama_produk,tbl_produk.deskripsi,tbl_jenis_usaha.jenis_usaha,tbl_produk_files.photo")
	...
	// 	q = q.Joins("join tbl_produk_files on tbl_produk_files.id_produk = t1.id_produk")
